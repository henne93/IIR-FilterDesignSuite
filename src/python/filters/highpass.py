"""2nd-order Butterworth High-Pass, per CONTRACTS.md §3."""
...
class HighPassFilter(FilterDesign):
    kind: ClassVar[Literal["HP"]] = "HP"
    ...
    def q14_coefficients(self, backend: NativeBackend) -> Q14Coefficients:
        return backend.design_hp(self.fc, self.fs)
